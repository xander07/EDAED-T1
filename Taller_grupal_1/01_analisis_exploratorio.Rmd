...
Visualizar la base de datos antes de iniciar a trabajar sobre ella es necesario. Primero ayudan a identificar si los datos sobre los cuales se va a trabajar son totalmente correctos.Y segundo, si presentan algún tipo de anomalía. Esto con el propósito de saber si los datos están listos para empezar a trabajar sobre ellos o se debe hacer algún proceso de depuración antes de, que permita posteriormente el análisis exploratorio. 

En este punto, luego de observar detenidamente la base de datos, se puede notar que, los datos aún no están  totalmente listos.Por tanto, se hace necesario realizar un proceso de depuración, que será descrito a continuación, veamos.  
...
¿La cantidad de recursos tecnológicos que poseen los estudiantes del curso de estadística descriptiva y exploratoria depende de su estrato socioeconómico?

La hipótesis que se plantea a esta pregunta es que sí, el hecho de que una persona pertenezca a un estrato mas alto, nos indica que, económicamente, estos poseen mayores y mejores recursos, y esto les permite adquirir muchas mas herramientas tecnológicas. Contrario a lo que pasaría con un estrato mas bajo, pues sus recursos económicos son mas limitados, y esto imposibilita que accedan a las distintas tecnologías 
...
author: "Kenneth Roy Cabrera Torres"
date: "Viernes, 26 de marzo de 2021"
modification: "Jhon Jairo Serna Córdoba, Laura Flórez"
output: 
  html_document: 
    toc: yes
---
...
Estas visualizaciones nos ayudan a identificar si los datos que tenemos son del tipo correcto, si tienen anomalías, y en general, si están listos para empezar a trabajar con ellos o debemos hacer algún proceso de depuración.

En este punto, con las visualizaciones que obtuvimos, los datos aún no están listos por tanto necesitaremos realizar un proceso de depuración, descrito a continuación: 
